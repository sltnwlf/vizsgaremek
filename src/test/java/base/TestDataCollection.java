...
public class TestDataCollection {
    ...
    public final static String username = "Felhasznalonev";
    public final static String usernameTestDataFromFile = "Felhasznalonev03";
    public final static String password = "Jelszo01";
    public final static String passwordTestDataFromFile = "Jelszo03";
    public final static String emailValid = "teszt@email.hu";
    ...
    public final static String description = "Egy rovid leiras.";
